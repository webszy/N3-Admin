...
import {LogoFacebook, LogoGithub, LogoWechat,LogoGoogle,MailUnreadOutline} from '@vicons/ionicons5'
</script>
  ...
  <div class="form">
    ...
    <NForm label-placement="top">>
      <NFormItem label="Email">
        <NFlex>
          <MailUnreadOutline class="h-full" />
          <NInput v-model="username" />
        </NFlex>
      </NFormItem>
    </NForm>
    ...
    <div class="flex-row">
      <button class="btn google">
        <svg id="Layer_1" style="enable-background:new 0 0 512 512;" version="1.1" viewBox="0 0 512 512" width="20"
...
<path d="M113.47,309.408L95.648,375.94l-65.139,1.378C11.042,341.211,0,299.9,0,256
	...
	C318.115,0,375.068,22.126,419.404,58.936z" style="fill:#F14336;"></path>
      ...
      <button class="btn apple">
        <svg id="Capa_1" height="20" style="enable-background:new 0 0 22.773 22.773;" version="1.1"
             viewBox="0 0 22.773 22.773" width="20" x="0px" xml:space="preserve"
             xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" y="0px"> <g> <g> <path
